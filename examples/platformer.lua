...
function player:collides(p)
    ...
    local p1 = {x=self.pos.x-dx,y=self.pos.y-self.h}
    local p2 = {x=self.pos.x-dx,y=self.pos.y}
    local p3 = {x=self.pos.x+dx,y=self.pos.y-self.h}
    local p4 = {x=self.pos.x+dx,y=self.pos.y}
